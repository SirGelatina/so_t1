...
// Por favor, valores maiores que 1
#define FATORIAL 1

//Na multiplicacao-> MULT_A = MULT_A * MULT_b
#define MULT_A 10
#define MULT_B 11 
...
const int ProgramDatabase[][MEMSIZE] = {
	...
	{	// 9, Fatorial
		...
		// 20 -			add t3, t1, zero
		// 24 -			add t5, t0, zero
		// 28 - mul: 	beq t3, t2, fim2 
		// 32 - 	 	add t0 t0 t5
		// 36 - 	 	sub t3 t3 t2
		// 40 - 	 	j mul
		// 44 - fim2: 	j fat

		// 48 - fim1:	slt v1 t0 t4
		// 52 -			or v0, t0, zero  
		// 56 -			and t4 t4 zero   

		// # -          v0 = saida do fatorial
		// # -          v1 = 1 se fatorial < 100;    0 c.c.

		/*0 */ 0b10101111101001000000000000000000,
		/*4 */ 0b10001111101010000000000000000000,
		/*8 */ 0b00000001000000000100100000100000,
		/*12*/ 0b00010001001010100000000000001000,
		/*16*/ 0b00000001001010100100100000100010,
		/*20*/ 0b00000001001000000101100000100000,
		/*24*/ 0b00000001000000000110100000100000,
		/*28*/ 0b00010001011010100000000000000011,
		/*32*/ 0b00000001000011010100000000100000,
		/*36*/ 0b00000001011010100101100000100010,
		/*40*/ 0b00001000000000000000000000000111,
		/*44*/ 0b00001000000000000000000000000011,
		/*48*/ 0b00000001000011000001100000101010,
		/*52*/ 0b00000001000000000001000000100101,
		/*56*/ 0b00000001100000000110000000100100,
