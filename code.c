...
const int ProgramDatabase[][MEMSIZE] = {
	...
	{	// 9, Fatorial
		...
		/*28*/ 0b00000001000011110100000000100000,
		/*32*/ 0b00000001011010100101100000100010,
		/*36*/ 0b00001000000000000000000000000110,
		/*40*/ 0b00001000000000000000000000000010,
		/*44*/ 0b00000001000011000001100000101010,
		/*48*/ 0b00000001000010100001000000100101,	
